...
def main():
    ...
    path_data = "//netfilec.ad.uni-heidelberg.de/home/i/in227/Desktop/FossGIS/OpenSourceGIS_exercise5/data"
    ...
    # subprocess.call(["v.distance", "-a", "from=studyarea@Christchurch", "to=airports@PERMANENT", "output=airport_distances", "upload=dist,to_attr", "column=airport_distance,airport", "from_type=centroid", "to_column=str_1", "table=airport_distances"])
